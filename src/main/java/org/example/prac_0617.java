...
public class prac_0617 {
    public static void main(String[] args) {
        ...
        // 강사님 해석: 문자열만 담을 수 있는 변수 mag에 greet 함수 실행 결과를 넣는다.
        String msg = greet("Jin");
        // msg를 출력, 실행결과:  Hello Jin!
        System.out.println(msg);

        // createPoint 함수에 포인트값 (5, 10)을 주어 Point형 참조타입변수 point에 넣겠다.
        // 강사님 해석: Point 참조타입변수 변수 point에 createPoint 함수 실행 결과를 넣는다.
        ...
        // Arrays.toString(evens) : 자바 배열 출력하기
    ...
    // 강사님 해석: 문자열 매개변수 1개를 받는 greet 메서드, static == 인스턴스화 없이 사용
    ...
    public static Point createPoint(int x, int y) {
        ...
        // 두 개가 타입이 다르기 때문에 꼭 객체생성을 해줘야한다. 아니면 타입매치오류가 날 수 있다.
    ...
    public static int[] firstNEvenNumbers(int n) {
        ...
        for (int i = 0, num = 2; i < n; i++, num += 2) { //num += 2 , num = num + 2
